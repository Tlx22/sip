...
import EventsPage, { initialEvents } from './pages/Events';
import SettingsPage from './pages/Settings';
import Community, { initialCommunityGroups } from './pages/Community';
...
export default function App() {
  ...
  // Shared moderation data - lifted here so both the source pages (Community,
  // Events, SocialPane) and the Moderation Dashboard see the same lists.
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#FBFBFA] font-sans text-gray-800 relative">
      ...
      {/* Floating Help Chatbot - available on every page */}
      <HelpChat />
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 bg-white">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8 relative">
          ...
          {currentPage === 'community' && (
            <Community
              triggerDirectMessage={handleDirectConnectMessagingSeed}
              communityGroupsData={communityGroups}
              onCommunityGroupsChange={setCommunityGroups}
            />
          )}
